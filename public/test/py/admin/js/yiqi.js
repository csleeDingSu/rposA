...
/*开源qq330729121*/
	...
	var Kheight = document.documentElement.clientHeight;
		...
		<div align=\"center\">\
			<p id=\"tsk-p\">"+wenzi+"</p>\
<div class='tskint tskint-yl' onclick='Newopen(\""+url+"\")'><p>预览</p></div>\
<div class='tskint tskint-fz' onclick='fzurl(\""+url+"\")'><p>二维码</p></div>\
<div class='tskint tskint-gb' onclick='gbtsk()'><p>关闭</p></div>\
			</div>";
...
function tishi(img,wenzi,time){
	...
	function fzurl(url){
		Newopen("http://bshare.optimix.asia/barCode?site=weixin&url="+url);

	}
function gbtsk(){
		var tsk = byId("tishik");
			document.body.removeChild(tsk);
}
