...
<body>
	<form action="shimingup.php" method="post" enctype="multipart/form-data">
	<div id='box'>
		<div id='dingwei'>
			<div class="pengyou-ss-head">
				<div class="pengyou-ss-head-left"><span onClick="Dqopen('index.php');">取消</span></div>
				<div class="pengyou-ss-head-right"><input type="submit" value="提交"></div>
			</div>
			<div class="pengyou-ss-dingwei">
				<div class="pengyou-ss-font">
					<textarea placeholder="这是实名认证，你有什么想说的吗" maxlength="1000" id ="pengyou-wz-nr" name="pengyou-wz-nr"></textarea>
				</div>
				<div class="pengyou-upload-insert">
						...
						<div class="pengyou-shiming-shuoming"><p>注意：请上传身份证正面和校卡的照片一共两张即可</p></div>
