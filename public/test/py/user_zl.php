...
@$User = intval($_GET['id']);
if(empty($User)){
	tishi(1,'没有该用户',3000,'index.php');
	die();
}
$hello=dtcxsql('pengyou_user','Id',$User);
?>
<?php
				...
				$username=htmlspecialchars($hello['username']);
				$touxiang = htmlspecialchars($hello['touxiang']);
...
<body id='Body'>
	<div id='box'>
		<div id='dingwei'>
			...
			<div class="pengyou-headimg" style="background-image:url(<?php echo "'./images/touxiang/$touxiang'" ?>);background-repeat:no-repeat;background-size:100% 86%;">
				<div class="pengyou-usergl-touxiang">
					<div class="pengyou-usergl-xgimg" align="center" onclick="Dqopen('userpyq.php?id=<?php echo $User?>');">
