    ...
    if(consecutive_lose == 'yes') {
        ...
        switch (level) {
            ...
            case 1:
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注10积分，猜中+10金币，猜错-10金币。';//'您选择<span class=\'caption_bet\'>[单数]</span>，猜中赚10金币，可兑换1元。';//'猜中得10，赚10金币。';
                $('.span-1').html("10");
                $('.span-2').html("30");
                $('.span-3').html("70");
                $('.span-4').html("150");
            ...
            case 2:
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注30积分，猜中+30金币，猜错-30金币。';//'您选择<span class=\'caption_bet\'>[单数]</span>，猜中得30，赚20金币。';//'猜中得30，扣除之前亏损10，赚20金币。';
                $('.span-1').html("-10");                        
                break;
            case 3:                    
                bet_amount = 70;
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注70积分，猜中+70金币，猜错-70金币。'; //'您选择<span class=\'caption_bet\'>[单数]</span>，猜中得70，赚30金币。';//'猜中得70，扣除前2次亏损40，赚30金币。';
                $('.span-1').html("-10");
                $('.span-2').html("-30");
                break;
            case 4:
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注150积分，猜中+150金币，猜错-150金币。'; //'您选择<span class=\'caption_bet\'>[单数]</span>，猜中得150，赚40金币。';//'猜中得150，扣除前3次亏损110，赚40金币。';
                $('.span-1').html("-10");
                $('.span-2').html("-30");
                $('.span-3').html("-70");
                break;
            case 5:
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注310积分，猜中+310金币，猜错-310金币。'; //'您选择<span class=\'caption_bet\'>[单数]</span>，猜中得310，赚50金币。';//'猜中得310，扣除前4次亏损260，赚50金币。';
                $('.span-1').html("-10");
                $('.span-2').html("-30");
                $('.span-3').html("-70");
                $('.span-4').html("-150");
            ...
            case 6:
                ...
                payout_info = '已选<span class=\'caption_bet\'>[单数]</span>，押注630积分，猜中+630金币，猜错-630金币。'; //'您选择<span class=\'caption_bet\'>[单数]</span>，猜中得630，赚60金币。';//'猜中得630，扣除前5次亏损570，赚60金币。';
                $('.span-1').html("-10");
                $('.span-2').html("-30");
                $('.span-3').html("-70");
                $('.span-4').html("-150");
