    ...
    function build(pointer) {
        ...
        var html =
                    '<div class="small-border g6" style="transform: rotate('+ degree +'deg);" w>' +
                        ...
                        '<div class="shan">' +
                            '<span class="span-odd"><span class="odd-sign">'+ cls_odd +'</span><span class="odd-payout">0</span>体验金</span>' +
                            '<div class="div-odd">单数 <span class="odd-number">1</span></div>' +
                        '</div>' +

                        '<div class="shan">' +
                            '<span class="span-even"><span class="even-sign">'+ cls_even +'</span><span class="even-payout">0</span>体验金</span>' +
