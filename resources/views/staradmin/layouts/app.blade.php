...
<html lang="{{ app()->getLocale() }}" ng-app="arcade-app">
    <head>
		...
		@section('top-css')
			...
			<link rel="stylesheet" href="{{ asset('/client/css/all.css') }}" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">
