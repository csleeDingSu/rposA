...
<div class="row">
		<div class="col-md-6">
			<div class="form-group row">
				<label for="alternative_contact_number" class="col-sm-6 col-form-label">@lang('dingsu.alternative') @lang('dingsu.contact_number') <span class="text-danger">*</span></label>
				<div class="col-sm-6">
		...
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<textarea name="address" class="form-control" >{{$list->address}}</textarea>
				</div>
			</div>
		</div>
	</div>
<div class="row">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group row">
				<label for="notes" class="col-sm-6 col-form-label">@lang('dingsu.notes') <span class="text-danger">*</span></label>
				<div class="col-sm-6">
					<textarea name="notes" class="form-control">{{$list->notes}}</textarea>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" name="tracking_partner" value="{{$list->tracking_partner}}">
				</div>
			</div>
		</div>
	</div>
