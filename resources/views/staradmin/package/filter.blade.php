			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col">
							<label>@lang('dingsu.package') @lang('dingsu.name')</label>
							<div id="the-basics">
								<input type="text" class="form-control typeahead tt-input" name="s_name" id="s_name" placeholder="@lang('dingsu.package') @lang('dingsu.name')">
							</div>
						</div>
