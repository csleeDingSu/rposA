					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="name" name="name" class="form-control" type="text" value="" maxlength="150">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="bank_detail" name="bank_detail" class="form-control" type="text" value="" maxlength="150">
								</div>
							</div>
						</div>
					</div> -->
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="account_name" name="account_name" class="form-control" type="text" value="" maxlength="150">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="account_number" name="account_number" class="form-control" type="text" value="" maxlength="150">
								</div>
							</div>
						</div>
					</div>
					...
					<!--	<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="bank_name" name="bank_name" class="form-control" type="text" value="" maxlength="150">
								</div>
							</div>
						</div>
					</div>
