...
<div class="loading2" id="loading2"></div>
        ...
        <div class="aliPayBox">
          ...
          <div class="paySeller">
            ...
            <p><span>订单编号</span><span class="status"><span class="orderid" id="orderid">{{empty($content->record->uuid) ? '' : $content->record->uuid}}</span><span class="copyBtnOrderId">复制</span></span></p>
