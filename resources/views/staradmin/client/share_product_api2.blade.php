...
@section('content')
	...
	<div class="infinite-scroll" id="product" style="height:100% !important;">
		<ul class="list-2">
			<li class="dbox" style="padding-bottom: 0.2rem;">
					...
					<span>
						...
						<div class="price1">
							<h3>
								...
								<span id="Pay" class="price2"></span>
								<span class="price3">
								淘宝价￥<span id="bonus"></span>
								</span>
							</h3>							
						</div>
					</span>							
...
$(function(){
	...
	//get from db	
	var temp_img = '<?php echo env('shareproduct_img', 'https://img.alicdn.com/bao/uploaded/i2/4204664043/O1CN01TCTohy1fjjnPv9Pte_!!0-item_pic.jpg'); ?>';
	var temp_taokey = '<?php echo '￥K8454DFGH45H￥'; ?>';
