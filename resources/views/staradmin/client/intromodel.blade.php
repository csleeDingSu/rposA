				...
				<div class="modal-row">
					<div class="wrapper modal-full-height">
						...
						<div class="row">
							...
							<a class="ssec_reg_btn" data-url="http://dev.boge56.com/member/login/register"  href="http://dev.boge56.com/member/login/register" target="_blank" rel="nofollow">没有帐号，去注册</a>
