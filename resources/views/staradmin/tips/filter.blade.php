			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group row">
						<div class="col">
							<label>@lang('dingsu.title')</label>
							<div id="the-basics">
								<input type="text" class="form-control typeahead tt-input " name="s_title" id="s_title" placeholder="@lang('dingsu.title')">
							</div>
						</div>
						
						<div class="col">
							<label>@lang('dingsu.content')</label>
							<div id="the-basics">
								<input type="text" class="form-control typeahead tt-input" name="s_content" id="s_content" placeholder="@lang('dingsu.content')">
							</div>
						</div>
