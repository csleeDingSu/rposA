<div class="row">
	...
	<div class="col-lg-12 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">@lang('dingsu.tips') @lang('dingsu.list')</h4>
					...
					<table class="table table-hover listtable" id="listtable">
						...
						<tbody>
							...
							<tr id="tr_{{ $list->id }}">
								...
								<td>
									<a href="javascript:void(0)" data-id="{{ $list->id }}"  class="edittip btn btn-icons btn-rounded btn-outline-info btn-inverse-info"><i class=" icon-pencil "></i></a>
