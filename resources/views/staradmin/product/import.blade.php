<div class="col-12 grid-margin">
	<div class="card">
		<div class="card-body">
			<h4 class="card-title">@lang('dingsu.import') @lang('dingsu.softpins')</h4>
			 <form class="form-horizontal" method="POST" action="{{ route('pin.import') }}" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group row">
							<label for="publish" class="col-sm-3 col-form-label">@lang('dingsu.duplicate')</label>
							<div class="col-sm-9">
								<div class="form-check">
                            <label class="form-check-label">
                              <input class="form-check-input" id="publish" name="publish" checked="" type="checkbox">
                              @lang('dingsu.remove') @lang('dingsu.duplicate')
