...
class GameController extends Controller
{
    ...
    {			
		...
		if ($validator->fails()) {
			...
			$current_result = Game::get_single_gameresult($gameid);
			...
			$insdata = ['member_id'=>$memberid,'game_id'=>$gameid,'game_level_id'=>'0','is_win'=>$is_win,'game_result'=>$status,'bet_amount'=>$betamt,'bet'=>$bet,'game_result'=>$current_result->game_result,'created_at'=>$now];				
